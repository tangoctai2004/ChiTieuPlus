...
// SỬA ĐỔI: Struct này giờ sẽ mang theo ID thay vì object
struct TransactionFormData {
    ...
    var date: Date
    var type: String
    var selectedCategoryID: NSManagedObjectID? // Thay đổi ở đây
}
...
class DataRepository {
    ...
    let categoriesPublisher = PassthroughSubject<[Category], Never>()
    let transactionsPublisher = PassthroughSubject<[Transaction], Never>()
    ...
    func addTransaction(formData: TransactionFormData) {
        ...
        // SỬA ĐỔI QUAN TRỌNG: Lấy category trong context hiện tại bằng ID
    ...
    func updateTransaction(
        ...
        if let categoryID = formData.selectedCategoryID,
           let categoryInContext = context.object(with: categoryID) as? Category {
            ...
            transactionToEdit.category = nil // Hoặc không thay đổi nếu không có ID mới
    ...
    // ... các hàm private helper và debug giữ nguyên ...
